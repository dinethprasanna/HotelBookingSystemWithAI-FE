...
function AboutUsPage() {
    return (
        <main>
            ...
            <div className="sm:flex items-center max-w-6xl mx-auto">
            ...
            <div className="max-w-6xl mt-12 mx-auto rounded-3xl bg-gradient-to-r from-green-100 to-green-50 px-6 py-16 text-center mb-12">
                <div className="relative m-auto max-w-xl">
                    ...
                    <a href="#" target="_blank">
                        <h2
                            className="mt-4 font-dm-sans text-mobile-h3 font-semibold leading-snug sm:text-mobile-h2 md:text-desktop-h2">
                            An
                            <span className="font-bold underline underline-offset-2">absolute 5/5</span> rating
                        </h2>
                    </a>
                    <p className="mt-4 font-dm-sans text-desktop-paragraph text-slate-body">Reviews are from our customers</p>
                    <svg className="absolute top-24 -left-10 hidden h-36 fill-current text-slate-body sm:block md:-left-14 md:h-44"
                    ...
                    <svg className="absolute top-24 -right-10 hidden h-36 fill-current text-slate-body sm:block md:-right-14 md:h-44"
                ...
                <div className="mt-6 flex flex-col items-center justify-center space-y-3">
                    <a href="#" target="_blank">
                        <img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-badge.svg?post_id=347156&amp;theme=light&amp;period=daily" width="250" height="54" />
                    </a>
                    <a href="#" target="_blank">
                        <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=347156&amp;theme=light" width="250" height="54" />
                    </a>
                </div>
